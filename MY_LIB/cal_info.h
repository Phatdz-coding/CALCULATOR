...
void solve_system_of_nonlinear_equation_display_help()
{
    const char *help[] = {
        ...
        "3. Function 2: exp(x)+y-1",
        "4. Variables: xy",
        "5. Lower bound: -2, Upper bound: 2",
        "   One possible solution is x ≈ -1.8, y ≈ 0.8",
        "\n✨ Tip",
...
void solve_n_degree_poly_display_help()
{
    const char *help[] = {
        ...
        "1. Enter degree: 5",
        "2. a₀=1, a₁=-15, a₂=85, a₃=-225, a₄=274, a₅=-120",
...
void derivative_calculator_display_help()
{
    const char *help[] = {
        ...
        "Right-click to paste the copy",
        "\n⌞ Example⌝",
        "Find the second derivative of 3x^4 - cos(x)",
        "1. Function: 3x^4 - cos(x)",
        "2. Press [Enter].",
        "3. Differentiate with respect to: x",
        "   Result (1st derivative): 12x^3 + sin(x)",
        "4. Leave function input empty and press [Enter].",
        "5. Differentiate with respect to: x",
        "   Result (2nd derivative): 36x^2 + cos(x)"};
